      ...
      <div ref={sectionRef} className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 hover-lift">
            <div className="mb-6">
              <h2 className="text-3xl font-bold mb-2 fade-up">Store Hours & Info</h2>
              <p className="text-muted-foreground fade-up">Visit us at your convenience. We're open daily!</p>
            </div>
            
            <div className="space-y-6">
              {/* Hours */}
              <div className="stagger-item">
                <div className="flex items-center space-x-3 mb-3 text-primary font-medium">
                  <Clock size={20} />
                  ...
                  {hours.map((item, index) => (
                    <div 
                      ...
                      className={cn(
                        ...
                        index === today ? "bg-primary/10 text-primary font-medium" : "text-muted-foreground"
                      )}
                    >
                      <span>{item.day}</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 border border-border rounded-xl stagger-item">
                  <div className="flex items-center space-x-3 mb-2 text-primary font-medium">
                    <Phone size={20} />
          ...
          {/* Mission */}
          <div className="space-y-6">
            <div className="inline-block px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium stagger-item">
              Our Mission
            </div>
            
            <h2 className="text-3xl md:text-4xl font-bold stagger-item">
              Sustainable Food, <br /> Sustainable Future
            </h2>
            
            <p className="text-muted-foreground stagger-item">
