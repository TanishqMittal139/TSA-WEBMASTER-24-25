...
export const sideItems: MenuItem[] = [
  ...
  },
  {
    ...
    price: 5.99,
    imageUrl: 'https://images.unsplash.com/photo-1573140401552-3fab0b24306f?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    category: 'sides',
    cuisineType: 'american',
    tags: ['bread', 'garlic'],
    vegetarian: true,
  ...
  },
  {
    ...
    price: 6.99,
    imageUrl: 'https://plus.unsplash.com/premium_photo-1696835870634-e6484e8ed4d7?q=80&w=2716&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    category: 'sides',
    cuisineType: 'american',
